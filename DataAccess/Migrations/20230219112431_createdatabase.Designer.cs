...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230219112431_createdatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Entities.Advert", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.GeneralSettings", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Images", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Neighbourhood", b =>
                {
                    b.Property<int>("NeighbourhoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Entities.Situation", b =>
                {
                    b.Property<int>("SituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Entities.Type", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Entities.UserAdmin", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Advert", b =>
                {
                    b.HasOne("Entity.Entities.Neighbourhood", "Neighbourhood")
                        .WithMany()
                        .HasForeignKey("NeighbourhoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Entities.Type", "Type")
                        .WithMany("Adverts")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Entities.UserAdmin", "UserAdmin")
                        .WithMany("Adverts")
            ...
            modelBuilder.Entity("Entity.Entities.Images", b =>
                {
                    b.HasOne("Entity.Entities.Advert", "Advert")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Entity.Entities.Type", b =>
                {
                    b.HasOne("Entity.Entities.Situation", "Situation")
                        .WithMany("Types")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Entity.Entities.UserAdmin", null)
                        .WithMany()
